    ...
    >
      ...
      <div ref={glassRef} className="glass-panel">
        <div ref={textRef} className="glass-inner">
          <h3 className="card-title">{t(`exp_gaming_${chIdx}_title`, "")}</h3>
          <span className="card-role">{t(`exp_gaming_${chIdx}_role`, "")}</span>
          <p className="card-desc">{t(`exp_gaming_${chIdx}_desc`, "")}</p>
        </div>
      </div>
